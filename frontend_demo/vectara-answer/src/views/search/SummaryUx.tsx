...
export const SummaryUx = () => {
  ...
  console.log("Entering SummaryUx:", { isSearching, searchResults, isSummarizing, summarizationResponse, searchResultsRef, selectedSearchResultPosition, fcsMode, factualConsistencyScore, enableStreamQuery });
