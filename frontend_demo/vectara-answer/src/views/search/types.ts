...
interface RawDocument {
  id: string;
  page_content: string;
  metadata: metaMetadata[];  // Define more specifically if possible
}
...
export type SearchResponse = myApiResponse // & SearchResult[]
...
// Assuming this interface is either in your types.ts file or somewhere relevant
...
export interface SearchResult {
  id: string;
  page_content: string;
  metadata: DocMetadata; // Define the structure of metadata if it has more specific fields
}
